        ...
        <div class="container">
            <div class="row d-flex align-items-center " >
                <section align="center" style="padding:20px;"  class="wow fadeInUp" >
                        <h1 class="black-text" style="font-weight:bold;">TESTIMONI</h1>
                                            ...
                                            <div class="card mb-2">
                                                <div class="card-body">
                                                            ...
                                                            <p align="left" style="float:left;">
                                                                <img src="{{asset('assets/img/testimonials/karina.jpeg')}}" class="z-depth-1" style="width:100px;">
                                                            </p>
                                                            <p ><span style="font-weight:bold;">Katharina</span> <br>Influencer</p>
                                                            <br><br>
                                        ...
                                        <div class="col-md-4">
                                            <div class="card mb-2">
                                                <div class="card-body">
                                                            ...
                                                            <p align="left" style="float:left;">
                                                                <img src="{{asset('assets/img/testimonials/YUNJIN.jpeg')}}" class="z-depth-1" style="width:100px;">
                                                            </p>
