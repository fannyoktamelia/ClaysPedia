...
@section('content')
    ...
    <div id="About" class="container-fluid" style="background:white;">
                    ...
                    <div class="row" style="margin-left:210px">
                        ...
                        <div class="col-md-4">
                            <div class="card mb-2">
                                <div class="card-body">
                                    <p style="float:center;">
                                        <img src="{{ asset('assets/img/value/belanja.png') }}" style="width:100px;">
                                    </p>
                        ...
                        <div class="col-md-4">
                            <div class="card mb-2">
                                <div class="card-body">
                                    <p style="float:center;">
                                        <img src="{{ asset('assets/img/value/diskusi.png') }}" style="width:100px;">
                                    </p>
        ...
        <div id="About" class="container-fluid" style="background:white;">
            ...
            <div class="row" style="margin-left:180px">
                <div class="col-md-5 wow animated zoomIn slow">
                    <img src="{{ asset('assets\img\galeri.png') }}" alt="" class="img-fluid">
                </div>
                    ...
                    <div class="row my-5" style="font-size:16px; font-family: 'Balsamiq Sans', cursive;">
                        <div class="col-md-6">
                            ...
                            <p align="left" style="font-family: 'Balsamiq Sans', cursive; margin-left:38px">
                                <a href="{{ url('galeri') }}" target="_blank" class="btn btn-dark">Lihat Semua</a>
                            </p>
                        </div>
                        {{-- <div class="col-md-6">
                            <ul align="left" style="list-style:none;">
                                <li><i class="fab fa-pagelines"></i> Diskusi dengan Para Ahli</li><br>
        ...
        <div id="About" class="container-fluid" style="background:white;">
            <br>
            {{-- <div class="row" style="margin-left:180px">
                <div align="left" class="col-md-12 wow animated flash slow">
                    <br>
                    <h1 class="black-text" style="font-weight:bold; margin-left:40px;">Galeri</h1>
                    <div class="col-md-3" style=" border-bottom: 2px solid #003399;"></div>
                    <div class="row my-5" style="font-size:16px; font-family: 'Balsamiq Sans', cursive;">
                        <div class="col-md-4">
                            ...
                            <p align="left" style="font-family: 'Balsamiq Sans', cursive; margin-left:38px">
                                <a href="{{ url('about') }}" target="_blank" class="btn btn-dark">Lihat Semua</a>
                            </p>
                        </div>
                        <div class="col-md-5 wow animated zoomIn slow">
            ...
            <div class="row mx-5">
                <div align="left" class="col-md-5 p-5 mx-5">
                    ...
                    <a href="{{ url('pembelajaran') }}" target="_blank" class="btn btn-dark">Mulai</a>
                </div>
                <div class="col-md-5 animated fadeInRight slow" style="margin-bottom:50px">
                    <img class="img-fluid slideshowimage" src=" {{ asset('assets/img/value/discuss.png') }}"
