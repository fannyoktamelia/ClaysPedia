...
<div align="center" style="background:#1CD5E8;padding:20px;">
        ...
        <p class="white-text" style="font-weight:bold;">
            ...
            <a href="{{url('admin-add-product')}}" class="badge badge-pill btn-dark disabled  px-3 py-2">   <i class="fas fa-plus"></i>  &nbsp; Tambah Produk Baru</a>
              ...
              <ul class="nav nav-tabs" id="myTab" role="tablist">
                  ...
                  <li class="nav-item">
                      <a class="nav-link" id="pstatus-tab" data-toggle="tab" href="#pstatus" role="tab" aria-controls="pstatus"
                        aria-selected="false">Harga Ongkir dan Status Produk</a>
                    </li>
                  <li class="nav-item">
                      ...
                      <div class="row" style="padding: 30px;">
                          ...
                          <div class="col-md-12">
                              <div class="form-group">
                                  ...
                                  <textarea rows="4" class="form-control"  name="small_description"   placeholder="Deskripsi singkat tentang produk"></textarea>
                              </div>
                          </div>
