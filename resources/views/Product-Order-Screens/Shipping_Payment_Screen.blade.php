<div class="col-md-7  " id="shipping_and_returns" >
    <form method="POST" action="order-proceed">
        ...
        <!--Form Data For Detail Order,....Starts Here-->
            @if(session('cart'))
                <?php $total=0;$count=0;$order_details='';$delivery_charges=0;?>
                    ...
                    @foreach(session('cart') as $id => $details)
                        ...
                        ('Nama Product:'.$details["item_name"].', Kuantitas : '.$details["item_quantity"].
            ...
            <div align="center" class="col-md-12">
                ...
                <button type="submit"   class="btn btn-dark btn-lg">Pesan</button>

            </div>
            
        <!--Form Data For Detail Order,....Ended Here-->
    </form>
</div>
