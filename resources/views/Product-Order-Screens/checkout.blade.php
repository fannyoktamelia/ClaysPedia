...
<h2 align="center" id="writetitle" class="black-text py-3" style="font-weight:bold;">Pesanan</h2>
<script>
    function Continue()
    {
                            ...
                            @if(session('cart'))
                                ...
                                <li>
                                        ...
                                        @foreach(session('cart') as $id => $details)
                                            ...
                                            <p align="right" >
                                                {{$details['item_quantity']}} X    Rp{{ number_format($details['Final_Price'], 0, ',', '.') }}
                                    ...
                                    <li>
                                        ...
                                        <h4 align="right" >
                                              <strong>
                                                Rp{{ number_format( $total +  $delivery_charges - session('discount') * $total / 100, 0, ',', '.')    }}</strong>
                                        </h4>
                                    </li>
                                    @endif

                                    <button onclick="Continue()" class="btaobtn btaobtn-outline-dark px-2 py-2">Lanjut ke Pembayaran</button>
