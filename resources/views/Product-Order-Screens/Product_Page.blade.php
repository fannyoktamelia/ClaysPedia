...
<p class="my-2 "  style="font-weight:bold; "><a href="{{url('/')}}" class="black-text">Beranda </a>/ {{$Product->name}} </p>
                            ...
                            @endif
                              ...
                              <p>{{$Product->description}}</p>
                                ...
                                <input type="hidden"   name="product_id"   min=0 value="{{$Product->id}}" required class="form-control product_id">
                                   <p> Harga : <strong style="font-size:20px;font-family: 'Balsamiq Sans', cursive;">Rp{{ number_format($Product->price, 0, ',', '.') }}</strong></p>
