...
<?php $__env->startSection('keywords'); ?> Beranda,Pembelajaran,Galeri,Forum,Etalase <?php $__env->stopSection(); ?>
...
<div class="px-5 py-2" style="background:#EEDDCC;margin-top:5px; ">
 ...
 <p class="my-2"> <span class="fas fa-bars fa-1x" style="font-size:20px;cursor:pointer;color:black;" onclick="openNav()"></span> <a href="/" class="black-text">Home></a>
    <a href="<?php echo e(url('dashboard')); ?>" class="black-text">Dashboard>
    </a> <strong class="black-text"> <a href="" class="black-text" >Profile </a> </strong> </p>
...
<div id="mySidenav" class="sidenav">
  ...
  <a href="<?php echo e(url('dashboard')); ?>"> <i class="fas fa-tachometer-alt"></i>  Beranda</a>
  <a href="<?php echo e(url('profile')); ?>" > <i class="fas fa-user"></i>   Profil</a>
  <a href="<?php echo e(url('Orders')); ?>"> <i class="fas fa-table"></i>  Pesanan</a>
...
<div class="container px-5">
    ...
    <h3 class="py-2  ">Profil</h3>
               ...
               <div class="col-md-12">
                            ...
                            <p>Akun dibuat pada:  <?php echo e(Auth::user()->created_at); ?></p>
                                       ...
                                       <div class="card-body">
                                                   <div class="row">
                                                       ...
                                                       <div class="col-md-3">
                                                           ...
                                                           <img src="https://www.lentoprints.com/public/images/user.webp"  alt="Foto Profil"  class="rounded-circle mx-5" style="width:50%">
                                                       ...
                                                       <div class="col-md-12 py-2">
                                                           ...
                                                           <div class="form-group">
                                                                <button type="submit" class="btn btn-success btn-lg"> Perbaharui    </button>
                                                                   <a  data-toggle="modal" data-target="#openpasswordmodel"    class="btaobtn btaobtn-outline-dark btaobtn-lg px-2 py-2"> Ubah Password    </a>
                                                           </div>
                                                       </div>
                                                   </div>
                                       </div>
                                   ...
                                   <div class="card">
                                       ...
                                       <div class="card-body">
                                                   <div class="row "  >
                                                       ...
                                                       <div class="col-md-6">
                                                           <div class="form-group">
                                                            <label> Alamat Detail (Co: Jalan, No. Rumah)</label>
                                                       ...
                                                       <div class="col-md-4">
                                                           <div class="form-group">
                                                            <label> Alamat Detail (Co : Patokan)</label>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="text-center">
          ...
          <h3 style="color: red"> Profil Tidak Dapat Diperbaharui </h3>
         <ul align="left"  >
                <?php if($errors->any()): ?>
 ...
 <div class="modal fade" id="openpasswordmodel" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
   ...
   <div class="modal-dialog modal-notify modal-primary" role="document">
     ...
     <div class="modal-content">
       <!--Header-->
       <div class="modal-header">
         <p class="heading lead">Ubah Password Anda</p>
       ...
       <div class="modal-body">
         <div class="text-center">
           ...
           <input type="password" class="form-control" name="newpass" placeholder="Masukkan Password Baru"><br>
            <input type="password" class="form-control" name="confirm_new_Pass" placeholder="Masukkan Kembali Password">
         </div>
       </div>
       ...
       <div class="modal-footer justify-content-center">
         ...
         <button type="submit" class="btn btn-outline-primary waves-effect" >Perbaharui</button>
       </div>
     </div>
     <!--/.Content-->
   </div>
