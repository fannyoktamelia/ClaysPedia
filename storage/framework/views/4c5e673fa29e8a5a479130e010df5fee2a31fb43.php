  ...
  <div class="container text-center text-md-left">
    ...
    <div class="row text-center text-md-left mt-3 pb-3">
      ...
      <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mt-3">
        ...
        <p>
          <a href="<?php echo e(url('Shop/Flowers-Fruits-Basket-Set')); ?>" target="_blank">Flowers / Fruits Basket Set </a>
        </p>
        <p>
          <a href="<?php echo e(url('Shop/Dusbin')); ?>" target="_blank">Dusbin</a>
        </p>
        <p>
          <a href="<?php echo e(url('Shop/Mat')); ?>" target="_blank">Mat</a>
        </p>
        <p>
          <a href="<?php echo e(url('Shop/Containers')); ?>" target="_blank">Containers  </a>
        </p>
      </div>
      <!-- Grid column -->
...
<!-- Footer --><?php /**PATH C:\laragon\www\cpedia\resources\views/Reusable_components/user/footer.blade.php ENDPATH**/ ?>