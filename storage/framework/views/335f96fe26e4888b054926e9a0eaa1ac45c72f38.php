<?php $__env->startSection('title'); ?> ClaysPedia About Us <?php $__env->stopSection(); ?>
...
THE ClaysPedia STORY</h3>
<p class="white-text" style="font-weight:bold;">    JOURNEY OF ClaysPedia FROM IDEATION TO STARTUP</p>
...
<div class="container-fluid" style="background:white;font-family: 'Balsamiq Sans', cursive;">
    <div class="row px-5">
        <div   class="col-md-12 ">
            <div align="center">
               <p class="col-md-4">
                    <img src="<?php echo e(asset('assets/img/logoclaysped.webp')); ?>" class="img-fluid" >
                </p>
            </div>
...
<h1 class="black-text" style="font-weight:bold;">  Lorem ipsum dolor sit amet, consectetur adipiscing elit</h1>
    ...
    <div align="center">
               <p class="col-md-4">
                    <img src="<?php echo e(url('Img/About/1.jpg')); ?>" class="img-fluid">
                </p>
    </div>
                          ...
                          <!--Slides-->
                              <div class="carousel-inner" role="listbox">
                                <div class="carousel-item active">
                                  <div class="view">
                                    <img class="d-block w-100" src="<?php echo e(url('Img/Gallary/1.jpg')); ?>"
                                      alt="First slide">
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\cpedia\resources\views/about.blade.php ENDPATH**/ ?>