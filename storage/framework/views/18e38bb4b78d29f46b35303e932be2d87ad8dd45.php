...
<section align="center" id="helpcenterindesktopmode">
    ...
    <a href="Frequently-Asked-Questions" align="center" type="button" class="btaobtn btaobtn-outline-primary btn-md  animated pulse infinite slow">Baca</a>
    </div>
    </div>
    ...
    <a href="Shipping-and-Returns" align="center" type="button" class="btaobtn btaobtn-outline-primary  btn-md  animated pulse infinite slow">Baca</a>
    </div>
    </div>
    ...
    <a href="Contact" align="center" type="button" class="btaobtn btaobtn-outline-primary  btn-md  animated pulse infinite slow">Baca</a>
    </div>
    </div>
...
<section id="helpcenterinmobilemode" align="center"  class="wow fadeInUp" id="featuredproducts">
    ...
    <a href="Frequently-Asked-Questions" class="btn btn-primary btn-md btn-rounded  animated pulse infinite slow">Baca</a>
    </div>
    </div>
    </div>
    </div>
    ...
    <a href="Shipping-and-Returns" class="btn btn-primary btn-md btn-rounded  animated pulse infinite slow">Baca</a>
    </div>
    </div>
    </div>
    </div>
    ...
    <a href="Contact" class="btn btn-primary btn-md btn-rounded  animated pulse infinite slow">Baca</a>
    </div>
    </div>
    </div>
    </div>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\cpedia\resources\views/Help.blade.php ENDPATH**/ ?>